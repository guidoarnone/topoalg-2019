...
Eleg\'i resolver los ejercicios $\paint{grey-light-blue}{(3)}$, $\paint{grey-light-blue}{()}$, y $\paint{grey-light-blue}{()}$. Por completitud, incluyo el ejercicio $\paint{grey-light-blue}{(4)}$ al comienzo ya que lo ulilizar\'e en la resoluci\'on de $\paint{grey-light-blue}{(3)}$. Con la intenci\'on de aumentar la legibilidad de las resoluciones, algunos argumentos est\'an escritos en forma de lemas que preceden a cada ejercicio.
