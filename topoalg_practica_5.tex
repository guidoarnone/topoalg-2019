...
y como su módulo $|\lambda| \equiv \|\delta\|$ solo se anula en cero, debe mantener su signo. Finalmente, como ya sabemos que $\lambda(1) = 1$, necesariamente es $\lambda \equiv \id$ y por tanto $\delta \equiv \ell$.
\end{proof}
